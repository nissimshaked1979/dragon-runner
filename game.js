...
const TRAILS = [
  { id: "fire", name: "שביל אש", englishName: "Fire Trail", tier: "מתחיל", englishTier: "Beginner", cost: 40000, kind: "fire", color: "#ff7a18", accent: "#ffd166", yOffset: 44, spread: 16, size: 18 },
  { id: "hearts", name: "שביל לבבות", englishName: "Heart Trail", tier: "יפה", englishTier: "Pretty", cost: 50000, kind: "heart", color: "#f472b6", accent: "#ffffff", yOffset: 38, spread: 18, size: 13 },
  { id: "gold-sparkles", name: "שביל ניצוצות זהב", englishName: "Gold Sparkle Trail", tier: "מבריק", englishTier: "Shiny", cost: 65000, kind: "sparkle", color: "#facc15", accent: "#ffffff", yOffset: 36, spread: 18, size: 14 },
  { id: "embers", name: "שביל גחלים", englishName: "Ember Trail", tier: "חם", englishTier: "Hot", cost: 80000, kind: "ember", color: "#fb923c", accent: "#fed7aa", yOffset: 40, spread: 18, size: 14 },
  { id: "leaves", name: "שביל עלים", englishName: "Leaf Trail", tier: "טבע", englishTier: "Nature", cost: 95000, kind: "leaf", color: "#22c55e", accent: "#166534", yOffset: 50, spread: 12, size: 15 },
  { id: "feathers", name: "שביל נוצות", englishName: "Feather Trail", tier: "נדיר", englishTier: "Rare", cost: 110000, kind: "feather", color: "#2563eb", accent: "#fef08a", yOffset: 32, spread: 22, size: 17 },
  { id: "snow", name: "שביל שלג", englishName: "Snow Trail", tier: "קפוא", englishTier: "Frozen", cost: 130000, kind: "snow", color: "#bae6fd", accent: "#ffffff", yOffset: 40, spread: 20, size: 15 },
  { id: "moon", name: "שביל ירח", englishName: "Moon Trail", tier: "לילה", englishTier: "Night", cost: 150000, kind: "moon", color: "#cbd5e1", accent: "#475569", yOffset: 34, spread: 18, size: 15 },
  { id: "tiger-stripes", name: "שביל פסים", englishName: "Stripe Trail", tier: "טורף", englishTier: "Predator", cost: 170000, kind: "stripe", color: "#f97316", accent: "#111827", yOffset: 42, spread: 18, size: 17 },
  { id: "hoof-clouds", name: "שביל פרסות", englishName: "Hoof Trail", tier: "מהיר", englishTier: "Fast", cost: 190000, kind: "hoof", color: "#a16207", accent: "#fde68a", yOffset: 58, spread: 8, size: 15 },
  { id: "giant-dust", name: "שביל ענני אבק", englishName: "Dust Cloud Trail", tier: "גדול", englishTier: "Big", cost: 215000, kind: "dust", color: "#94a3b8", accent: "#e2e8f0", yOffset: 58, spread: 12, size: 18 },
  { id: "gems", name: "שביל יהלומים", englishName: "Gem Trail", tier: "יוקרתי", englishTier: "Luxury", cost: 240000, kind: "gem", color: "#dc2626", accent: "#facc15", yOffset: 36, spread: 20, size: 16 },
  { id: "waves", name: "שביל גלים", englishName: "Wave Trail", tier: "ים", englishTier: "Sea", cost: 265000, kind: "wave", color: "#38bdf8", accent: "#ffffff", yOffset: 44, spread: 18, size: 16 },
  { id: "ribbons", name: "שביל סרטים", englishName: "Ribbon Trail", tier: "אפי", englishTier: "Epic", cost: 290000, kind: "ribbon", color: "#f9a8d4", accent: "#fff7ed", yOffset: 32, spread: 22, size: 17 },
  ...
  { id: "pulse", name: "שביל פעימות", englishName: "Pulse Trail", tier: "חזק", englishTier: "Power", cost: 340000, kind: "pulse", color: "#b45309", accent: "#facc15", yOffset: 44, spread: 16, size: 16 },
  { id: "coffee", name: "שביל קפה", englishName: "Coffee Trail", tier: "סודי", englishTier: "Secret", cost: 365000, kind: "coffee", color: "#92400e", accent: "#ffedd5", yOffset: 34, spread: 18, size: 16 },
  { id: "cactus", name: "שביל קקטוסים", englishName: "Cactus Trail", tier: "מדבר", englishTier: "Desert", cost: 390000, kind: "cactus", color: "#22c55e", accent: "#fef3c7", yOffset: 48, spread: 12, size: 15 },
  { id: "peppers", name: "שביל פלפלים", englishName: "Pepper Trail", tier: "חריף", englishTier: "Spicy", cost: 420000, kind: "pepper", color: "#ef4444", accent: "#facc15", yOffset: 40, spread: 18, size: 15 },
  { id: "forest", name: "שביל יער", englishName: "Forest Trail", tier: "אגדי", englishTier: "Legendary", cost: 450000, kind: "forest", color: "#15803d", accent: "#a3e635", yOffset: 44, spread: 16, size: 16 },
  { id: "rainbow", name: "שביל קשת", englishName: "Rainbow Trail", tier: "הכי יפה", englishTier: "Most Beautiful", cost: 475000, kind: "rainbow", color: "#38bdf8", accent: "#f0abfc", yOffset: 34, spread: 22, size: 18 },
  { id: "sixty-seven", name: "שביל 67", englishName: "67 Trail", tier: "הכי יקר", englishTier: "Most Expensive", cost: 500000, kind: "number", color: "#2563eb", accent: "#facc15", yOffset: 34, spread: 20, size: 18 },
];
